...
export const vpsInstance = pgTable('vps_instance', {
  ...
  gatewayState: text('gateway_state').notNull().default('ready'),
  gatewayRestartStartedAt: timestamp('gateway_restart_started_at'),
  gatewayReadyConfirmedAt: timestamp('gateway_ready_confirmed_at'),
