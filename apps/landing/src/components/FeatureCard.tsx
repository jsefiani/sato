...
export default function FeatureCard({
  ...
  const illustrationContainerClass =
    variant === 'telegram'
      ? 'h-72 overflow-hidden rounded-t-3xl'
      : 'h-72 overflow-hidden rounded-t-3xl bg-gradient-to-br from-brand-light/50 to-transparent'
  ...
  return (
    ...
    >
      <div className="relative z-10">
        <div className={illustrationContainerClass}>
