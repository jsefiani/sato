...
void main(){
  ...
  if (uCenterFade > 0.0) {
    ...
    M *= smoothstep(0.0, uCenterFade, dist);
  }
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const onPointerDown = (e: PointerEvent) => {
        ...
        ;(uniforms.uClickPos.value as Array<THREE.Vector2>)[ix].set(fx, fy)
      ...
      const animate = () => {
        ...
        if (composer) {
          ...
          composer.passes.forEach((p) => {
            const effs = (p as any).effects as Array<Effect> | undefined
            if (effs)
